      ...
      <div className="flex flex-col gap-24">
          ...
          {stats.map((stat, i) => (
            <div key={i} className="glass-card p-8 group relative overflow-hidden transition-all duration-300 hover:bg-white/[0.05]">
              ...
              <div className="flex items-baseline gap-3 flex-wrap">
                ...
                <span className="text-xs font-extrabold text-green-500">{stat.trend}</span>
              </div>
            </div>
          ))}
        </div>
        ...
        <div className="grid grid-cols-1 gap-8">
          <div className="flex items-center justify-between px-4 mb-2">
            <span className="text-xs font-black text-dark-500 uppercase tracking-[0.2em]">Active Quotations ({mockRFQs.length})</span>
