      ...
      <BrowserRouter>
        <div className="min-h-screen bg-gradient-to-br from-dark-950 via-dark-900 to-dark-950 flex flex-col">
          ...
          <div className="flex-1 flex flex-col items-center w-full">
            <main className="w-full max-w-[1800px] px-6 md:px-12 py-20 relative z-10 flex flex-col items-center">
              <Routes>
          ...
          <footer className="bg-dark-950/50 border-t border-white/5 py-10">
